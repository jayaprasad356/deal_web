...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
    	...
    	if($path=='') {
    		...
    		$statement = $pdo->prepare("INSERT INTO tbl_users (full_name,email,phone,password,photo,role,status) VALUES (?,?,?,?,?,?,?)");
    		...
    		$statement = $pdo->prepare("SHOW TABLE STATUS LIKE 'tbl_users'");
    		$statement->execute();
    	...
    	$success_message = 'users is added successfully.';
    }
}
?>
