...
define('DOMAIN_URL', "https://ifscfinder.in/"); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
  ...
  // private $db_user = "u743445510_telugucalweb";  
   ...
   // private $db_name = "u743445510_telugucalweb";    
    ...
    // private $db_name = "u762811021_tc";    // Change as required
     ...
     //Test
     private $db_host = "localhost";  // Change as required
     private $db_user = "u762811021_deal";  // Change as required
     private $db_pass = "Deal@2023";  // Change as required
     private $db_name = "u762811021_deal";    // Change as required
